...
if (request.getParameter("sort") !=null) {
  if (request.getParameter("sort").equals("lp")) {
    sqlStr = "SELECT * FROM gpus ORDER BY price ASC";
  }

  if (request.getParameter("sort").equals("hp")) {
    sqlStr = "SELECT * FROM gpus ORDER BY price DESC";
  }

  if (request.getParameter("sort").equals("az")) {
    sqlStr = "SELECT * FROM gpus ORDER BY name ASC";
  }

  if (request.getParameter("sort").equals("za")) {
    sqlStr = "SELECT * FROM gpus ORDER BY name DESC";
  }
}
  ...
  <body class="bg_default">
    ...
    <div style="padding-left: 50px; padding-right: 50px">
      ...
      <div class="d-flex mb-3">
        <h4 class="p-2">Graphics Cards</h4>
      </div>
          ...
          <div class="col">
            <div class="card h-100">
              ...
              <div class="card-footer">
                ...
                <%
                    String listing = "SELECT * FROM listings WHERE type = 'gpus' AND itemID = '" +rset.getString("id")+"'";
